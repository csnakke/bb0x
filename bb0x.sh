...
sudo apt-get install -y net-tools wget iputils-ping curl vim tmux screenfetch gdebi git unzip bat exa lolcat openssh-server docker-compose docker.io jq snap xclip samba
